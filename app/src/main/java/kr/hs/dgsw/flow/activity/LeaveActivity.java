...
public class LeaveActivity extends FragmentActivity implements DatePickerDialog.OnDateSetListener,
    ...
    private Call<kr.hs.dgsw.flow.network.networkModel.Out.Response.Response> mOutRequest;
    private Call<kr.hs.dgsw.flow.network.networkModel.Sleep.Response.Response> mSleepRequest;
        ...
        if(isDateBlank()) {
            ...
            if(type == 0) {
                mOutRequest = mService.out(DatabaseManager.selectToken(),
                        new kr.hs.dgsw.flow.network.networkModel.Out.Request.Request(
                                startDate, endDate, mOutReason.getText().toString()));

                mOutRequest.enqueue(new Callback<kr.hs.dgsw.flow.network.networkModel.Out.Response.Response>() {
                    @Override
                    public void onResponse(Call<kr.hs.dgsw.flow.network.networkModel.Out.Response.Response> call, retrofit2.Response<kr.hs.dgsw.flow.network.networkModel.Out.Response.Response> response) {
                    ...
                    @Override
                    public void onFailure(Call<kr.hs.dgsw.flow.network.networkModel.Out.Response.Response> call, Throwable t) {
                ...
                mSleepRequest = mService.sleep(DatabaseManager.selectToken(),
                        new kr.hs.dgsw.flow.network.networkModel.Sleep.Request.Request(
                                startDate, endDate, reason));

                mSleepRequest.enqueue(new Callback<kr.hs.dgsw.flow.network.networkModel.Sleep.Response.Response>() {
                    @Override
                    public void onResponse(Call<kr.hs.dgsw.flow.network.networkModel.Sleep.Response.Response> call, retrofit2.Response<kr.hs.dgsw.flow.network.networkModel.Sleep.Response.Response> response) {
                        if(response.errorBody() != null) {
                            try {
                    ...
                    @Override
                    public void onFailure(Call<kr.hs.dgsw.flow.network.networkModel.Sleep.Response.Response> call, Throwable t) {
                        Snackbar.make(mLeaveRoot, R.string.error_server_error,
                                Toast.LENGTH_SHORT).show();
                    }
                });
